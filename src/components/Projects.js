  ...
  return(
    ...
    <div className="box-containerP">
        ...
        <div className="boxP">
            ...
            <a href="https://weatherworldapp-simon.herokuapp.com/" className="btn hbtn">view</a>
        ...
        <div className="boxP">
            ...
            <a href="https://piano-keyboard2.netlify.app/" className="btn hbtn">view</a>
        </div>
        <div className="boxP">
            <h3>E-CARE</h3>
            ...
            />
            <a href="https://ecare-test.netlify.app/" className="btn hbtn">view</a>
        </div>
        <div className="boxP">
            <h3>CSSP APP</h3>
            ...
            <a href="https://github.com/Simon-157/CSSP-PORTAL" className="btn hbtn">view</a>
        </div>
        <div className="explore">
            <a href="https://github.com/Simon-157?tab=repositories" className="btn hbtn">Explore more
            <FontAwesomeIcon
                        
                icon={faArrowAltCircleRight} className= "iconE"
            />
            </a>
        </div>
